        ...
        <div class="row">
            ...
            <div data-aos="fade-right" data-aos-delay="600" data-aos-duration="1000"
                ...
                <div class="btn-group gap-2">
                    <a href="{{ route('my-experience') }}" target="_blank" class="btn btn-primary"
                        style="border: 2px dotted white">mY History</a>
                    <a href="{{ asset('assets/other/CV-Muhammad-alfian-izzah.pdf') }}" target="_blank"
                        class="btn btn-success" style="border: 2px dashed white">Show My Cv</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-dark">
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-3" style="border: 5px solid salmon">
                                <div class="row g-0">
                                    <div class="col-md-4 d-flex justify-content-center align-items-center">
                                        <div class="img-thumbnail" style="background-color: #fccde2">

                                            <svg class="img-fluid" style="transform: scale(.7)"
                                                xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="850.53801"
                                                height="740.82953" viewBox="0 0 850.53801 740.82953"
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#f2f2f2" />
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#2f2e41" />
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#fff" />
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#e6e6e6" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#ffffff" />
                                                <path
                                                ...
                                                <polygon
                                                    ...
                                                    fill="#2f2e41" />
                                                <circle id="b6132315-04e2-4cdb-a713-107c9cd58b0b"
                                                    data-name="ab6171fa-7d69-4734-b81c-8dff60f9761b" cx="282.81438"
                                                    cy="176.73277" r="68.32185" fill="#ffb6b6" />
                                                <path id="f4304bdd-ba2d-4fff-b404-410205410c5d-198"
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#cacaca" />
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#ffb6b6" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#3f3d56" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#3f3d56" />
                                                <circle cx="285.90293" cy="348.70373" r="31.30642" fill="#ffffff" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#3f3d56" />
                                                <ellipse cx="532.21834" cy="258.90901" rx="2.5" ry="7"
                                                    transform="translate(-204.70468 -5.69071) rotate(-7.72549)"
                                                    fill="#3f3d56" />
                                                <ellipse cx="529.21834" cy="240.90901" rx="2.5" ry="7"
                                                    transform="translate(-202.31223 -6.25736) rotate(-7.72549)"
                                                    fill="#3f3d56" />
                                                <ellipse cx="548.21834" cy="247.90901" rx="2.5" ry="7"
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-174.73099 -79.58524)" fill="#ffffff" />
                                                <ellipse cx="378.62896" cy="274.52323" rx="2.5" ry="7"
                                                    transform="translate(-228.45065 16.61926) rotate(-13.53051)"
                                                    fill="#3f3d56" />
                                                <ellipse cx="368.62896" cy="277.52323" rx="2.5" ry="7"
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title h4">Website developer</h5>
                                            <p class="fs-6">mengembangkan website, membuat website memiliki
                                                fungsi didalamnya, membuat sistem informasi, API, dan lainnya</p>
                                ...
                                <div class="row g-0">
                                    <div class="col-md-4 d-flex justify-content-center align-items-center">
                                        <div class="img-thumbnail d-flex justify-content-center align-items-center"
                                            style="background-color: #46c3db">

                                            <svg class="img-fluid" style="transform: scale(.7)"
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1"
                                                width="1164.07" height="555.93" viewBox="0 0 1164.07 555.93">
                                                <defs>
                                                    <linearGradient id="ac59aa7e-40f5-4d5f-b82f-fdd6bf7d03ee-302"
                                                        x1="439.31" y1="679.56" x2="439.4" y2="679.56"
                                                        gradientUnits="userSpaceOnUse">
                                                        <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                                                        <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                                                        <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                                                    </linearGradient>
                                                    <linearGradient id="72a3db62-0825-44ad-a640-19754e14ba99-303"
                                                        x1="186.82" y1="533.62" x2="458.12" y2="533.62"
                                                        xlink:href="#ac59aa7e-40f5-4d5f-b82f-fdd6bf7d03ee-302" />
                                                    <linearGradient id="060ac890-45f2-497a-b51d-740a183b02f3-304"
                                                        x1="-1193.63" y1="706.12" x2="-1193.63" y2="383.52"
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" fill="#ffffff"
                                                    opacity="0.1" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" fill="#ffffff" />
                                                <path d="M439.4,679.55l0,0h0Z" transform="translate(-17.96 -172.03)"
                                                    fill="url(#ac59aa7e-40f5-4d5f-b82f-fdd6bf7d03ee-302)" />
                                                <path
                                                    ...
                                                    fill="url(#72a3db62-0825-44ad-a640-19754e14ba99-303)" />
                                                <path
                                                ...
                                                <polygon
                                                    ...
                                                    fill="#a36468" />
                                                <path d="M282.84,679.24h.46l-.86.33Z"
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" fill="#d38884" />
                                                <path d="M341.1,496.79s-7,8.5-5.88,14.06h8.49l6.21-7Z"
                                                    transform="translate(-17.96 -172.03)" fill="#67647e" />
                                                <path
                                                ...
                                                <path d="M757,695.27h0Z" transform="translate(-17.96 -172.03)"
                                                    fill="#d3dae1" />
                                                ...
                                                <path d="M757,695.27h0Z" transform="translate(-17.96 -172.03)"
                                                    opacity="0.1" />
                                                <path d="M756.54,695.27h0Z" transform="translate(-17.96 -172.03)"
                                                    fill="#3a3768" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)"
                                                    fill="url(#060ac890-45f2-497a-b51d-740a183b02f3-304)" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" fill="#efb7b9" />
                                                <path d="M913.77,728H911.3a0,0,0,0,1,0,0h2.44Z"
                                                    transform="translate(-17.96 -172.03)" fill="#efb7b9" />
                                                <path
                                                    d="M905.88,687.39s1.22,9.06,2.77,18.62l-3.55-.18q-14.24-.74-28.51-1.89c-5.4-12.51-11-27.36-11-27.59s-.17-5.12-.36-10.58c-.06-1.92-.13-3.9-.19-5.76h0c-.1-2.82-.19-5.36-.24-6.94,0-1.08-.06-1.72-.06-1.72s-5.14.9-9.76,1.53l-2.05.27c-1.06.13-2,.23-2.85.29a7.33,7.33,0,0,1-2.21,0c-1.58-.61,1.7-16,1.7-16l8.16-19.75,2.28-5.5,1-.25c.49-.12,1.15-.26,1.94-.41,7.79-1.43,28.6-3.25,32.13,17.29,4.37,25.37,5,31.07,5,31.07Z"
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" opacity="0.1" />
                                                <path d="M830.65,669.32s-2.79,4.86-5.22,4.37Z"
                                                    transform="translate(-17.96 -172.03)" opacity="0.1" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" fill="#67647e" />
                                                <path d="M722.14,572.71s-4.13,3.88-7.53,4.91Z"
                                                    transform="translate(-17.96 -172.03)" opacity="0.1" />
                                                <path
                                                    d="M712.31,584.24s10.07-.37,11.28-2.43S712.31,584.24,712.31,584.24Z"
                                                    transform="translate(-17.96 -172.03)" opacity="0.1" />
                                                <path d="M707.33,598.68c.61,0,12.74-1.7,13.23-3.28Z"
                                                    transform="translate(-17.96 -172.03)" opacity="0.1" />
                                                <path d="M703.57,607.91c4.37-.13,11.77-4.86,11.77-4.86Z"
                                                    transform="translate(-17.96 -172.03)" opacity="0.1" />
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-17.96 -172.03)" fill="#67647e" />
                                                <g opacity="0.7">
                                                    <path d="M933,179.57h165.67V340.71H933Z"
                                                        transform="translate(-17.96 -172.03)" fill="#2e001e" />
                                                    <path
                                                ...
                                                <g opacity="0.7">
                                                    <path id="88e22766-bb2e-4d8a-8c4e-873561c02ed1-305" data-name="a"
                                                        d="M246.31,244.46l56.62,110.81L207.77,244.46Z"
                                                        transform="translate(-17.96 -172.03)" fill="#ea6c00" />
                                                    <path id="dcb2c17a-6570-4f03-a416-11c2a206e419-306" data-name="b"
                                                        d="M359.56,244.46,302.94,355.27,398.1,244.46Z"
                                                        transform="translate(-17.96 -172.03)" fill="#ea6c00" />
                                                    <path id="d2c5ae9b-dccc-4d4c-8aa0-840002be2480-307" data-name="c"
                                                        d="M246.31,244.46H359.54L302.93,355.27Z"
                                                        transform="translate(-17.96 -172.03)" fill="#fdad00" />
                                                    <path id="616bf47a-f8e5-41ce-b525-03b6ad416eda-308" data-name="d"
                                                        d="M302.93,183.05l-53.64,5.67-3,55.74Z"
                                                        transform="translate(-17.96 -172.03)" fill="#fdd231" />
                                                    <path id="ca73b31d-b223-4f6c-ac2e-edd2597912ec-309" data-name="e"
                                                        d="M302.93,183.05l53.63,5.67,3,55.74Z"
                                                        transform="translate(-17.96 -172.03)" fill="#fdd231" />
                                                    <path id="2a7c7013-4804-45aa-950a-2b5376f70ef0-310" data-name="f"
                                                        d="M398.1,244.46l-41.52-55.74,3,55.74Z"
                                                        transform="translate(-17.96 -172.03)" fill="#fdad00" />
                                                    <path id="5dac32ab-c712-4de9-a97f-2e05661e9f0b-311" data-name="g"
                                                        d="M207.77,244.46l41.52-55.74-3,55.74Z"
                                                        transform="translate(-17.96 -172.03)" fill="#fdad00" />
                                                    <path id="2d1bbfda-86f6-4da7-9bb0-15ddbbfa97e7-312" data-name="h"
                                                        d="M302.93,183.05l-56.62,61.41H359.54Z"
                                                        transform="translate(-17.96 -172.03)" fill="#feeeb7" />
                                                </g>
                                            </svg>
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title h4">Design
                                            </h5>
                                            <p class="fs-6">Develop a good user interface and user experience,
                                                with a beautiful and comfortable appearance</p>
                ...
                <div class="col-lg-6 mt-2">
                    <h1 class="fs-1 h1 text-primary">TOP SERVICE</h1>

                    <p>Hai saya alfianizzah, Saya sangat suka teknologi, saya belajar teknologi dari smp sampe sekarang
                    </p>
                    <p>tapi dalam beberapa service yang disamping kiri, saya lebih berfokus ke developer, bisa dibilang
                        saya sangat familiar dibidang database(mysql), dan juga sistem informasi, jika anda mempercayai
                        saya, Saya pasti tidak akan mengecewakan anda</p>
                </div>
            </div>
        </div>
    </div>
                ...
                @forelse ( $project as  $p)
                    <div class="item">
                        <div class="card">
                            ...
                            <a class="card-header p-0" style="height: 300px" href="{{ asset("storage/$p->picture") }}"
                                data-lightbox="models" data-title="{{ $p->desc }}">
                                <img style="height: 100%;object-fit: cover;width: 100%;object-position: top"
                                    src="{{ asset("storage/$p->picture") }}" />
                            </a>

                            <div class="card-body border-0 text-center">
                                <a target="_blank" href="{{ $p->link }}">{{ $p->nama }}</a>
                                <h6 class="text-dark">{{ $p->teknologi }}</h6>
            ...
            <div class="row">
                <div class="col-lg-3 intro-text col-12 d-flex justify-content-center" style="border: 4px dashed white">
                    <img src="{{ asset('assets/img/alfianizzahheader.png') }}"
                        class="d-none d-md-block img-line img-fluid" style="object-fit: cover;filter: grayscale(1)"
                        height="450" alt="">
                </div>
                        ...
                        <div class="item-keuntungan owl-carousel owl-theme py-3">
                            <div class="item">
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="content-body mt-3">
                                        <h4 class="py-2 text-success">Kerja sama</h4>
                            ...
                            <div class="item">
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="content-body mt-3">
                                        <h4 class="py-2 text-success">Mengajar</h4>
                                ...
                                <div class="col-12 mb-3">
                                    <div class="card bg-dark">
                                        <div class="card-body">
                                            ...
                                            <svg class="img-fluid" style="max-height: 120px"
                                                xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="691"
                                                height="571.22835" viewBox="0 0 691 571.22835"
                                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                                ...
                                                <circle id="bfd52db7-3176-431c-b22d-4ccf50ae4673"
                                                    data-name="Ellipse 188" cx="349.78151" cy="247.9577" r="9.74625"
                                                    fill="#2f2e41" />
                                                <path id="b31e8c25-48a3-409d-90cd-0f3aa66812dd-23" data-name="Path 969"
                                                    ...
                                                    transform="translate(-254.5 -164.38583)" fill="#2f2e41" />
                                                <circle id="fe71adb6-1e7d-40f2-ae2d-2f206863ade9"
                                                    data-name="Ellipse 189" cx="349.97817" cy="281.77689" r="28.63055"
                                                    fill="#2f2e41" />
                                                <path id="e07a90a6-c331-41ef-a441-b6d8bd717078-24" data-name="Path 970"
                                                    ...
                                                    transform="translate(-254.5 -164.38583)" fill="#2f2e41" />
                                                <circle id="fefa9ca9-d901-48cd-a772-63aab06ef99d"
                                                    data-name="Ellipse 190" cx="349.73536" cy="291.72509" r="18.43954"
                                                    fill="#a0616a" />
                                                <path
                                                    ...
                                                    transform="translate(-254.5 -164.38583)" fill="#6c63ff" />
                                                <ellipse id="eb9de4e7-d719-4e1b-ab1d-c7fc470b1049"
                                                    data-name="Ellipse 191" cx="331.05301" cy="287.84364" rx="1.45569"
                                                    ry="2.66857" fill="#a0616a" />
                                                <ellipse id="a295d86f-11aa-4df2-91d0-9ecb8f1fab78"
                                                    data-name="Ellipse 192" cx="368.41888" cy="287.84364" rx="1.45569"
                                                    ry="2.66857" fill="#a0616a" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    transform="translate(-254.5 -164.38583)" fill="#6c63ff" />
                                                <circle id="e8fe815c-89b6-45a1-8f09-a3d9b2d7a5fa"
                                                    data-name="Ellipse 109" cx="593.97253" cy="487.5152" r="23.34625"
                                                    fill="#a0616a" />
                                                <path id="b463a6a0-335d-4c85-b501-8d2679f87106-25" data-name="Path 696"
                                    ...
                                    <div class="content-body mt-3">
                                        <h4 class="py-2 text-success">Support System</h4>
                                        <p>Saya juga tertarik menjadi support system yang membantu dalam tim</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: cover;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/html.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: cover;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/css.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/scss.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/js.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/jquery.gif') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/bootstrap.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/php.svg') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/mysql.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/ci.jpg') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/laravel.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
                    <img style="object-fit: contain;height: 100%;width: 100%;"
                        src="{{ asset('assets/img/tekno/git.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-1 col-2" style="max-height: 90px">
