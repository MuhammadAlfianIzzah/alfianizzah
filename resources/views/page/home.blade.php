<x-main-layout>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p class="fs-6">Kembangkan antarmuka pengguna dan pengalaman
                                                pengguna yang baik, dengan tampilan yang indah dan nyaman, saya biasanya
                                                menggunakan figma dan photoshop untuk melakukan desain</p>
    ...
    <div class="section-keuntungan bg-dark">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row keuntungan-item-container">
                        <div class="item-keuntungan owl-carousel owl-theme py-3">
                            <div class="item">
                                <div class="card">
                                    <div class="card-header">
                                        <img src="{{ asset('assets/img/combination.png') }}" class="card-img-top"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="item">
                                <div class="card">
                                    <div class="card-header">
                                        <img src="{{ asset('assets/img/tech.png') }}" class="card-img-top"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="item">
                                <div class="card">
                                    <div class="card-header">
                                        <img src="{{ asset('assets/img/help.png') }}" class="card-img-top"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
